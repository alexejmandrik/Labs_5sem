...
int main()
{
	...
	try
	{
		...
		//serv.sin_addr.s_addr = inet_addr("172.20.10.3");  // адрес сервера
		...
		cout << "Колличество итераций: ", cin >> count;
		...
		for(int i = 0; i < count; i++)
		{
			...
			if ((libuf = recv(cC, in, sizeof(in), 0)) == SOCKET_ERROR) throw SetErrorMsgText("recv:", WSAGetLastError());
		}

		cout << "Время: " << clock() - t << endl;
		string t55;
		cin >> t55;
