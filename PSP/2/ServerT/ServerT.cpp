...
string  GetErrorMsgText(int code)    
{
	...
	case WSAEMFILE:	msgText = "Слишком много файлов окрыто"; break;
...
int main(int argc, _TCHAR* argv[])
{
	...
	try
	{
		...
		while (true)
		{
			...
			cout << "После accept" << endl;
			cout << "IP клиентика: " << inet_ntoa(c_adr.sin_addr) << endl << "Порт: " << htons(c_adr.sin_port) << endl;
